...
import { UserType } from 'src/app/shared/quiz-results/quiz-results.component';
...
export class FormationDetailComponent implements OnInit, OnDestroy {
  ...
  quizzes: Quiz[] = [];
  userType: UserType = UserType.Supervisor; // Définir le type d'utilisateur comme superviseur
